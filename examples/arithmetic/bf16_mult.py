...
def spec_bf16_mult(x: BFloat16, y: BFloat16, ctx) -> BFloat16:
...
if __name__ == "__main__":
    ...
    with open("examples/c_models/bf16_multiplier_jit.cpp", "w") as file:
        file.write(multiplier.to_cpp(jittable=True))

    with open("examples/c_models/bf16_multiplier_no_jit.cpp", "w") as file:

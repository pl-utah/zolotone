...
def spec_ue4m3_to_fp32(x: UE4M3, ctx) -> Float32:
    return Cases(
...
if __name__ == "__main__":
    ...
    with open("examples/c_models/ue4m3_to_fp32_jit.cpp", "w") as file:
        file.write(cast.to_cpp(jittable=True))

    with open("examples/c_models/ue4m3_to_fp32_no_jit.cpp", "w") as file:

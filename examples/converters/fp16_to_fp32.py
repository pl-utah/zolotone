...
def spec_fp16_to_fp32(x: Float16, ctx) -> Float32:
    return Cases(
...
if __name__ == "__main__":
    ...
    with open("examples/c_models/fp16_to_fp32_jit.cpp", "w") as file:
        file.write(cast.to_cpp(jittable=True))

    with open("examples/c_models/fp16_to_fp32_no_jit.cpp", "w") as file:

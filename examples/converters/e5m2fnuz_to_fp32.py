...
def spec_e5m2fnuz_to_fp32(x: E5M2FNUZ, ctx) -> Float32:
    return Cases(
...
if __name__ == "__main__":
    ...
    with open("examples/c_models/e5m2fnuz_to_fp32_jit.cpp", "w") as file:
        file.write(cast.to_cpp(jittable=True))

    with open("examples/c_models/e5m2fnuz_to_fp32_no_jit.cpp", "w") as file:

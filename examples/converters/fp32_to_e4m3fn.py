...
def spec_fp32_to_e4m3fn(x: Float32, ctx) -> E4M3FN:
    return Cases(
...
if __name__ == "__main__":
    ...
    with open("examples/c_models/fp32_to_e4m3fn_jit.cpp", "w") as file:
        file.write(cast.to_cpp(jittable=True))

    with open("examples/c_models/fp32_to_e4m3fn_no_jit.cpp", "w") as file:

...
def round_mantissa_spec(m: UQ, e: UQ, ctx) -> Tuple(UQ, UQ):
...
def normalize_to_1_xxx_spec(m: UQ, e: Q, ctx) -> Tuple(UQ, Q):
...
def shift_if_subnormal_spec(m: UQ, e: Q, ctx) -> Tuple(UQ, UQ):
